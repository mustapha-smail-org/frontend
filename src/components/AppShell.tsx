    ...
    <div className="min-h-screen bg-[var(--background)] text-[var(--foreground)]">
      ...
      <footer className="site-footer shell-pad">
        <div className="mx-auto grid max-w-[88rem] gap-10 py-12 md:grid-cols-[1.2fr_0.8fr_0.8fr]">
          ...
          <div><p className="footer-title">À propos</p><Link href="/mentions-legales">Mentions légales</Link><Link href="/confidentialite">Confidentialité</Link><p className="mt-4 text-xs text-white/45">Source : Paris Open Data</p></div>
        </div>
      </footer>
    </div>
  );
